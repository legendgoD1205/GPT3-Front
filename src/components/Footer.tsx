  ...
  return (
    <>
      <div className="w-full bg-gray-100 h-full">
        <div
          className="h-44 flex justify-center items-top bg-[#0B0B0B]/30 backdrop-blur-[4px] border-t-[#353535]"
          id="footer"
        >
          <div
            className="cursor-pointer text-white font-bold uppercase text-sm px-6 py-3 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
